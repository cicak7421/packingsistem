...
const inventoryRoutes = require('./_lib/routes/inventory');

const app = express();
app.use(cors());
// Limit dinaikkan dari default 100kb karena upload gambar produk (inventory) dikirim
// sebagai base64 lewat JSON body -- tetap di bawah limit request body Vercel (~4.5MB Hobby).
